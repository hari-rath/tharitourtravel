...
<div class="container mx-auto pt-6">
    <h1 class="text-2xl font-extrabold mb-6">Add New Banner</h1>
    ...
    <form action="<?= base_url('admin/banner/save'); ?>" method="post" enctype="multipart/form-data"
        ...
        <div class="flex flex-wrap gap-4 mb-6">
            ...
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" name="title" value="<?= old('title') ?>" placeholder="Banner Title"
