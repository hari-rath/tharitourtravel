...
<div class="container mx-auto p-6">
    ...
    <div class="flex justify-between">
        <h1 class="text-2xl font-extrabold mb-6">Gallery</h1>
            ...
            <?php foreach ($images as $index => $image): ?>
                <tr class="border-b">
                    ...
                    <td class="p-3 space-x-4">
                        <a href="<?= base_url('admin/gallery/edit/' . $image['id']); ?>" class="text-blue-600 hover:text-blue-800" title="Edit">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="<?= base_url('admin/gallery/delete/' . $image['id']); ?>" class="text-red-600 hover:text-red-800" title="Delete" onclick="return confirm('Are you sure?')">
